...
function getPayload() {
  ...
  return {
    candidate: {
      ...
      piScore: document.getElementById("piScore").value,
      typingTestScore: document.getElementById("typingTestScore").value,
...
async function submitInterview() {
  ...
  piScore: Number(payload.candidate.piScore || 0),
  typingTestScore: Number(payload.candidate.typingTestScore || 0),
